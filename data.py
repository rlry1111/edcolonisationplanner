...
# Values from Colonization Construction Details (By DaftMav) -- https://docs.google.com/spreadsheets/d/1jsZOzNJSnPIWlU88puOc9gQXvsw-MGp8meoQ6k-Yj-Y/copy?usp=sharing

#            NAME                              SLOT   IP MP SEC TL  W SoL DL  cost   T2    T3
add_building("Orbis_or_Ocellus",              "space", 5, 1, -3, 7, 8,  5, 9, 209122, 0, "port", first_station_offset=0.20)
add_building("Coriolis",                      "space", 1, 1, -2, 2, 3,  3, 3,  53723, "port", 1, first_station_offset=0.33)
add_building("Asteroid_Base",                 "space", 1, 1, -1, 3, 5, -4, 7,  53723, "port", 1, first_station_offset=0.33)

add_building("Commercial_Outpost",            "space", 1, 1, -1, 0, 3,  5, 0,  18988,      1, 0, first_station_offset=0.1641)
add_building("Industrial_Outpost",            "space", 1, 1,  0, 3, 0,  0, 3,  18988,      1, 0, first_station_offset=0.1641)
add_building("Criminal_Outpost",              "space", 1, 1, -2, 0, 3,  0, 0,  18988,      1, 0, first_station_offset=0.1641)
add_building("Civilian_Outpost",              "space", 1, 1, -1, 0, 1,  2, 1,  18988,      1, 0, first_station_offset=0.1641)
add_building("Scientific_Outpost",            "space", 1, 1,  0, 3, 0,  0, 0,  18988,      1, 0, first_station_offset=0.1641)
add_building("Military_Outpost",              "space", 1, 1,  2, 0, 0,  0, 0,  18988,      1, 0, first_station_offset=0.1641)

add_building("Satellite",                     "space", 0, 0,  0, 0, 1,  2, 1,   6721,      1, 0)
add_building("Communication_Station",         "space", 0, 0,  1, 3, 0,  0, 0,   6721,      1, 0)
add_building("Space_Farm",                    "space", 0, 0,  0, 0, 0,  5, 1,   6721,      1, 0)
add_building("Pirate_Base",                   "space", 0, 0, -4, 0, 4,  0, 0,   6721,      1, 0)
add_building("Mining_Outpost",                "space", 0, 0,  0, 0, 4, -2, 0,   6721,      1, 0)
add_building("Relay_Station",                 "space", 0, 0,  1, 0, 0,  0, 1,   6721,      1, 0)

add_building("Military",                      "space", 0, 0,  7, 0, 0,  0, 0,  10080,     -1, 1, dependencies=["Small_Military_Settlement", "Medium_Military_Settlement", "Large_Military_Settlement"])
add_building("Security_Station",              "space", 0, 0,  9, 0, 0,  3, 3,  10080,     -1, 1, dependencies=["Relay_Station"])
add_building("Government",                    "space", 0, 0,  2, 0, 0,  7, 3,  10080,     -1, 1)
add_building("Medical",                       "space", 0, 0,  0, 3, 0,  5, 0,  10080,     -1, 1)
add_building("Research_Station",              "space", 0, 0,  0, 8, 0,  0, 3,  10080,     -1, 1, dependencies=["Small_Scientific_Settlement", "Medium_Scientific_Settlement", "Large_Scientific_Settlement"])
add_building("Tourist",                       "space", 0, 0, -3, 0, 6,  0, 3,  10080,     -1, 1, dependencies=["Small_Tourism_Settlement", "Medium_Tourism_Settlement", "Large_Tourism_Settlement"])
add_building("Space_Bar",                     "space", 0, 0, -2, 0, 3,  3, 0,  10080,     -1, 1)

#            NAME                              SLOT   IP MP SEC TL  W SoL DL  cost   T2    T3
add_building("Civilian_Planetary_Outpost",   "ground", 2, 1, -2, 0, 0,  3, 0,  36829,      1, 0)
add_building("Industrial_Planetary_Outpost", "ground", 1, 1, -1, 0, 3,  0, 0,  36829,      1, 0)
add_building("Scientific_Planetary_Outpost", "ground", 1, 1, -1, 5, 0,  0, 1,  36829,      1, 0)
add_building("Planetary_Port",               "ground",10,10, -3, 5, 5,  7,10, 215882, 0, "port")

add_building("Extraction_Hub",               "ground", 0, 0,  0, 0,10, -4, 3,   9800,     -1, 1, dependencies=["Small_Extraction_Settlement", "Medium_Extraction_Settlement", "Large_Extraction_Settlement"])
add_building("Civilian_Hub",                 "ground", 0, 0, -3, 0, 0,  3, 3,   9800,     -1, 1, dependencies=["Small_Agricultural_Settlement", "Medium_Agricultural_Settlement", "Large_Agricultural_Settlement"])
add_building("Exploration_Hub",              "ground", 0, 0, -1, 7, 0,  0, 3,   9800,     -1, 1, dependencies=["Communication_Station"])
add_building("Outpost_Hub",                  "ground", 0, 0, -2, 0, 0,  3, 3,   9800,     -1, 1, dependencies=["Space_Farm"])
...
add_building("High_Tech_Hub",                "ground", 0, 0, -2,10, 3,  0, 0,   9800,     -1, 1)
add_building("Industrial_Hub",               "ground", 0, 0,  0, 3, 5, -4, 3,   9800,     -1, 1, dependencies=["Mining_Outpost"])

add_building("Small_Agricultural_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, standard_of_living=3, construction_cost=2840, T2points=1)
add_building("Medium_Agricultural_Settlement", "ground", initial_population_increase=1, max_population_increase=1, standard_of_living=7, construction_cost=5690, T2points=1)
add_building("Large_Agricultural_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, standard_of_living=10, construction_cost=8530, T2points=-1, T3points=2)

add_building("Small_Extraction_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, wealth=3, construction_cost=2840, T2points=1)
add_building("Medium_Extraction_Settlement", "ground", initial_population_increase=1, max_population_increase=1, wealth=5, construction_cost=5690, T2points=1)
add_building("Large_Extraction_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, tech_level=2, wealth=8, standard_of_living=-2, construction_cost=8530, T2points=-1, T3points=2)

add_building("Small_Industrial_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, development_level=3, construction_cost=2840, T2points=1)
add_building("Medium_Industrial_Settlement", "ground", initial_population_increase=1, max_population_increase=1, development_level=6, construction_cost=5690, T2points=1)
add_building("Large_Industrial_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, development_level=9, wealth=3, construction_cost=8530, T2points=-1, T3points=2)

add_building("Small_Military_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, security=2, construction_cost=2840, T2points=1)
add_building("Medium_Military_Settlement", "ground", initial_population_increase=1, max_population_increase=1, security=4, construction_cost=5690, T2points=1)
add_building("Large_Military_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, security=7, development_level=3, construction_cost=8530, T2points=-1, T3points=2)

add_building("Small_Scientific_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, tech_level=3, development_level=1, construction_cost=2840, T2points=-1, T3points=1)
add_building("Medium_Scientific_Settlement", "ground", initial_population_increase=1, max_population_increase=1, tech_level=7, development_level=1, construction_cost=5690, T2points=-1, T3points=1)
add_building("Large_Scientific_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, tech_level=10, development_level=3, construction_cost=8530, T2points=-1, T3points=2)

add_building("Small_Tourism_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, security=-1, wealth=1, construction_cost=2840, T2points=-1, T3points=1, dependencies=["Satellite"])
add_building("Medium_Tourism_Settlement", "ground", initial_population_increase=1, max_population_increase=1, security=-1, wealth=3, construction_cost=5690, T2points=-1, T3points=1, dependencies=["Satellite"])
add_building("Large_Tourism_Settlement",  "ground", initial_population_increase=1, max_population_increase=1, security=-1, wealth=5, construction_cost=8530, T2points=-1, T3points=2, dependencies=["Satellite"])
